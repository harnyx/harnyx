...
- `EndpointAssignment` binds an assignment UUID, `Query`, query digest, expected miner hotkey and HTTPS endpoint URL, HTTPS validator callback URL, explicit search URL, optional opaque `callback_context`, nonce, and expiry.
