...
from harnyx_commons.rating_competition import RatingAnswer, RatingJudgment, RatingWork
from harnyx_miner_sdk.endpoint_protocol import EndpointCallback, query_digest


def verified_rating_answer(answer: RatingAnswer, query: Query) -> Response:
